...
namespace CarBook.WebUI.Controllers
{
    ...
    public class AdminCarController : Controller
    {
        ...
        public async Task<IActionResult> CreateCar(CreateCarDto createCarDto)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7060/api/Cars", stringContent);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.DeleteAsync($"https://localhost:7060/api/Cars/{id}");
            if (responseMessage.IsSuccessStatusCode)
            {
                return RedirectToAction("Index");
            }
        ...
        public async Task<IActionResult> UpdateCar(int id)
        {
            var client = _httpClientFactory.CreateClient();
            //MArka dropdown için
            var responseMessage1 = await client.GetAsync("https://localhost:7060/api/Brands");
